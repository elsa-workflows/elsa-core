...
The [shared package icon decision](shared-package-icon-disposition.md) records
the identical retained icon blobs and downloaded Studio/Slack package content.
It settles only those two icon rows, not package publishing or cutover.
