...
The fresh 95a preparation used Core `95a658b96107ad4dbb280a13972479af74bc6a30`, Extensions `33fa0bfd28c7585240e3d4f665058c067b17e287`, and Studio `9afd3e36fd1bc90dfdf8ea00b40d89e4a50c8822`. Its canonical `Elsa.sln` contains 167 imported/added projects. SDK 10.0.300 evaluated 2,586 Debug/Release, default/source/package-reference cases; all effective package IDs were stable and non-empty, and all cases had `IsPackable=false` and `GeneratePackageOnBuild=false`. The canonical packability report SHA-256 is `5b720229d7f58da91a4c62aaf19670acea6212638c013dfcc676713fba6b5d18`; the preparation receipt SHA-256 is `5fd5df724698e010932a741633936a12d39e506743195482b33e68d9154d0238`. This evaluation preceded the four listed compatibility/test-layout patch applications, so it does not independently establish their effective package properties. The exact patches and current run state are listed in the [source-profile ledger](canonical-source-profile-ledger.json). A canonical NUKE `Test` run is underway; build and test completion remains unclaimed until the full run receipt is recorded.
