...
[The machine-readable snapshot](hierarchy.json) records each issue, native parent edge and explicit blocking edge separately. Both directed graphs are acyclic. The 2026-09-23 UTC refresh includes PostgreSQL coordination story #8308 under #8222, PostgreSQL persistence task #8309, and separate-worker crash-recovery task #8310: **90 issues, 89 parent edges and 39 separate blocking edges**. The story and persistence task depend on offboarding #8296; the process proof depends on #8309. All issue titles/states and native relationships were read back from GitHub and the complete snapshot passed live verification. In particular #8271, #8290 and #8300 are closed; this dated snapshot is not a guarantee about later execution.
