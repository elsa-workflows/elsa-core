...
[The machine-readable snapshot](hierarchy.json) records each issue, native parent edge and explicit blocking edge separately. Both directed graphs are acyclic. The 2026-09-23 refresh includes the credential story #8269, completed lifecycle task #8270, renamed workflow-binding task #8271, Secrets compatibility story #8275 and its SQLite characterization task #8276, offboarding task #8296, EF persistence task #8300 under #8286 blocking #8292, and Secrets API/Studio compatibility task #8301 under #8275 blocked by #8290: **87 issues, 86 parent edges and 36 separate blocking edges**. It also refreshes #8195 and #8205–#8208 as closed, #8270 as closed, and #8271 as open. Issue titles, states, and native relationships were read back from GitHub and the complete snapshot passed live relationship verification; this dated snapshot is not a guarantee about later execution.
