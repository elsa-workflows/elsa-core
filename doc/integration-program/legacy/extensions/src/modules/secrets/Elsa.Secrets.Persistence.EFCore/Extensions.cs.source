...
public static class Extensions
{
    ...
    /// </summary>
    public static SecretManagementFeature UseEntityFrameworkCore(this SecretManagementFeature feature, Action<EFCoreSecretPersistenceFeature>? configure = null)
    {
