...
| Secrets | [Elsa.Secrets](../../src/modules/Elsa.Secrets) | Named secrets with pluggable stores, extensible secret types (text, RSA key, X.509 certificate), versioning, rotation, revocation, secret resolver, and management endpoints. |
