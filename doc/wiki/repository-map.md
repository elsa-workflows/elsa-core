...
| [test/workers](../../test/workers) | In-process worker hosts used as fixtures in credential lifecycle and integration tests (e.g. `Elsa.Connections.Credentials.WorkerProcess`). |
| [test/TlsSmoke](../../test/TlsSmoke) | Minimal runnable host for TLS certificate and mutual-TLS smoke validation. |
...
| Outbound connections | [Elsa.Connections](../../src/modules/Elsa.Connections), [Elsa.Connections.Credentials.Workflows](../../src/modules/Elsa.Connections.Credentials.Workflows), [Elsa.Connections.Credentials.Persistence.EFCore](../../src/modules/Elsa.Connections.Credentials.Persistence.EFCore), provider packages (`Sqlite`, `PostgreSql`) | Connection lifecycle abstractions for outbound integrations: OAuth credential storage (backed by `Elsa.Secrets`), use-grant management, workflow-scoped credential bindings, host-only metadata inspection, background reconciliation worker. Authorization defaults to deny-all; hosts supply `IConnectionUseAuthorizer`, `IConnectionCredentialShareAuthorizer`, and an `IConnectionCredentialGrantManagementAuthorizer` implementation. ADRs: [2026-09-23](../adr/2026-09-23-integration-credential-lifecycle.md), [2026-09-25 (inspection)](../adr/2026-09-25-connection-metadata-inspection-boundary.md), [2026-09-25 (sharing)](../adr/2026-09-25-separate-workflow-connection-sharing-authorization.md). |
| Platform integration | [Elsa.Platform.Integration](../../src/modules/Elsa.Platform.Integration) | Shell feature that polls Elsa Platform for deployment commands and applies Loom recipe artifacts (workflow definitions, feature configuration) to a running Elsa runtime via `ElsaPlatformDeploymentWorker`. Depends on `WorkflowManagementFeature`. |
