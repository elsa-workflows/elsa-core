...
| User tasks | [Elsa.UserTasks](../../src/modules/Elsa.UserTasks), [Elsa.UserTasks.Persistence.EFCore](../../src/modules/Elsa.UserTasks.Persistence.EFCore), [Elsa.UserTasks.Persistence.VNext](../../src/modules/Elsa.UserTasks.Persistence.VNext), and EF Core provider packages | Durable workflow-bound human tasks: `UserTask` activity, candidate/assignee/supervisor access model, guest invitations, form resolution and validation, lifecycle management, REST surface, and EF Core and vNext persistence across all providers. See [doc/user-tasks.md](../user-tasks.md) and [specs/013-user-tasks](../../specs/013-user-tasks/spec.md). |
