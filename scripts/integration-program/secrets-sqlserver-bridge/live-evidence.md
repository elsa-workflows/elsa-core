...
Status: **accepted Core pin; final fixture rerun pending**. The candidate run against #8358 before merge verified five released-package source rows, fresh Core conversion, old-package reopen with unchanged source hashes, mapped tenant read isolation, and 14 rejection scenarios. Its redacted report had `cutoverAllowed=false` and no printed connection string, generated password, key, plaintext or ciphertext. The full integration-program Python suite passed 207 tests in standard and optimized modes. The fixture now pins accepted main commit `c37e9d7a2fa7e7c2af802b211e3d59db45fc2f6f`; the full live proof must be rerun against that commit and this exact fixture code before it becomes final compatibility evidence.
