...
for module in "${mods[@]}"; do
    ...
    for provider in "${providers[@]}"; do
        ...
        ef-migration-runtime-schema --interface Elsa.EntityFrameworkCore.IElsaDbContextSchema --efOptions "migrations add V3_4 -c ""$module""ElsaDbContext -p ""$providerPath""  -o ""$migrationsPath"""
    done
done
