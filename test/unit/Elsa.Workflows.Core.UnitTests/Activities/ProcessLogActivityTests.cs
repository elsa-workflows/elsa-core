...
namespace Elsa.Workflows.Core.UnitTests.Activities;
...
public class ProcessLogActivityTests
{
    ...
    {
        // Act
        var activity = new ProcessLogActivity("Test message", Models.LogLevel.Information);
    ...
    public void ProcessLogEntry_CanBeCreated()
    {
        ...
        var level = Models.LogLevel.Warning;
