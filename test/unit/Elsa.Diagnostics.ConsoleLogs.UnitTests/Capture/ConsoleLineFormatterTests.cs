...
{
    [Fact]
    public void Format_PreservesAnsiByDefault()
    {
    ...
    [Fact]
    public void Format_StripsAnsiWhenConfigured()
    {
        var formatter = new ConsoleLineFormatter(Microsoft.Extensions.Options.Options.Create(new ConsoleLogsOptions { StripAnsiEscapeSequences = true }));
