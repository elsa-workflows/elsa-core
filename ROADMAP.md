...
Last refreshed: 2026-09-05 (release-status corrections for Elsa 3.8.0)
...
6. Productize the BPMN runtime/interchange foundation: complete validation and conformance work, define the supported subset, package it, and start the Studio rendering/authoring slice.
