...
import { Components, InputDefinition, OutputDefinition } from '@elsa-workflows/elsa-workflows-designer';
...
//export declare interface ContextConsumer extends ContextConsumer {}
...
export declare interface ElsaInputTagsDropdown extends Components.ElsaInputTagsDropdown {
  ...
  valueChanged: EventEmitter<CustomEvent<Array<string | IElsaInputTagsDropdownSelectListItem>>>;
}
...
export declare interface ElsaVariablesEditor extends Components.ElsaVariablesEditor {
  ...
  variablesChanged: EventEmitter<CustomEvent<Array<[IElsaVariablesEditorVariable]>>>;
}
...
export declare interface ElsaWorkflowDefinitionInputOutputSettings extends Components.ElsaWorkflowDefinitionInputOutputSettings {
   ...
   inputsChanged: EventEmitter<CustomEvent<Array<InputDefinition>>>;

   outputsChanged: EventEmitter<CustomEvent<Array<OutputDefinition>>>;
