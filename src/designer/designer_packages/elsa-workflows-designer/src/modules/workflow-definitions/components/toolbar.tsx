...
export class Toolbar {
  ...
  render() {
    ...
    return (
      <div class="elsa-panel-toolbar tw-flex tw-justify-center tw-absolute tw-border-b tw-border-gray-200 tw-top-0 tw-px-1 tw-pl-4 pb-2 tw-text-sm tw-bg-white tw-z-10 tw-space-x-2">
