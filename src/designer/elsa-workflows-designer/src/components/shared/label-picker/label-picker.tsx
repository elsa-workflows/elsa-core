...
import {EditIcon} from "../../icons/tooling";
...
export class LabelPicker {
  ...
  private renderFlyout = () =>
    <div ref={el => this.flyoutPanel = el} class="absolute z-10 right-0 transform mt-3 px-2 w-screen max-w-md px-0"
      ...
      <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
        <div class="mx-auto max-w-3xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all opacity-100 scale-100">
          <div class="relative">
            ...
            <input class="h-12 w-full border-0 bg-transparent pl-11 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm" placeholder="Search..." role="combobox" type="text"
                   aria-expanded="true" value=""/></div>
                  ...
                  <div class="flex-grow ">
                    <div class="flex gap-1.5">
                      <div class="flex-shrink-0 flex flex-col justify-center ">
                        <div class="w-4 h-4 rounded-full bg-pink-600" aria-hidden="true"/>
                      </div>
                      <div class="flex-grow">
                        <p class="text-sm font-medium text-gray-900 font-bold">Page</p>
                      </div>
                    </div>
                    <div>
                      <p class="text-sm font-normal text-gray-500">A description about the label.</p>
                    </div>
                  </div>
                </div>
              </a>
              ...
              <a class="block select-none rounded-xl p-3 bg-white hover:bg-gray-100" href="#">
                <div class="flex justify-start gap-1.5">
                  ...
                  <div class="flex-grow ">
                    ...
                    <div>
                      <p class="text-sm font-normal text-gray-500">A description about the label that is quite very long. Maybe a little bit too long?</p>
                    </div>
                  </div>
                </div>
              </a>
