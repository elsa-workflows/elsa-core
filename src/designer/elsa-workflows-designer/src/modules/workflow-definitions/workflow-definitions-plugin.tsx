...
import {ActivityDescriptor, Plugin, WorkflowDefinition, WorkflowDefinitionSummary} from "../../models";
...
import {WorkflowDefinitionUpdatedArgs} from "./models";
...
import {PublishClickedArgs} from "./workflow-publish-button";
...
export class WorkflowDefinitionsPlugin implements Plugin {
  ...
  private readonly apiClientProvider: ElsaApiClientProvider;
  ...
  constructor() {
    ...
    this.apiClientProvider = Container.get(ElsaApiClientProvider);
  ...
  async initialize(): Promise<void> {
    this.elsaClient = await this.apiClientProvider.getElsaClient();
  }
