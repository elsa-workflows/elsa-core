...
const purgecss = require('@fullhuman/postcss-purgecss')({
  ...
  safelist: ['hidden', 'jtk-connector', 'jtk-endpoint', 'jtk-hover', 'rose', 'sky', /gray/, /pink/, /blue/, /green/, /red/, /yellow/, /rose/, 'label-container', 'node', 'start', 'activity', 'elsa-border-blue-600', 'elsa-border-green-600', 'elsa-border-red-600'],
});
