...
namespace Elsa.Studio.ExternalAuthentication.BlazorServer.HttpMessageHandlers;

/// <summary>Attaches the server-held broker access token to authenticated Studio backend requests.</summary>
