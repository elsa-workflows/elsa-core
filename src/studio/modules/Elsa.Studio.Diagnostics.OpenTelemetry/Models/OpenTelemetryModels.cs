namespace Elsa.Studio.Diagnostics.OpenTelemetry.Models;
...
public record TelemetrySpanEvent(string Name, DateTimeOffset Timestamp, IDictionary<string, string?> Attributes);

public record TelemetrySpanLink(string TraceId, string SpanId, IDictionary<string, string?> Attributes);
