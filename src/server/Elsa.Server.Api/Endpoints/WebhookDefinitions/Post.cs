...
namespace Elsa.Server.Api.Endpoints.WebhookDefinitions
{
    ...
    public partial class Save : ControllerBase
    {
        ...
        public async Task<ActionResult<WebhookDefinition>> Handle([FromBody] Elsa.Server.Api.Endpoints.WebhookDefinitions.SaveRequest request, [FromRoute] ApiVersion apiVersion, CancellationToken cancellationToken)
        {
            ...
            return CreatedAtAction("Handle", "GetByDefinitionId", new { definitionId = webhookDefinition.DefinitionId, apiVersion = apiVersion.ToString() }, webhookDefinition);
        }
    }
}