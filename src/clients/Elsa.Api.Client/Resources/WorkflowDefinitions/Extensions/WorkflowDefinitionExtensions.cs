...
public static class WorkflowDefinitionExtensions
{
    ...
    {
        if (!workflowDefinition.CustomProperties.TryGetValue("VariableTestValues", out var dictionary))
        {
            var testValues = new Dictionary<string, object?>();
            workflowDefinition.CustomProperties["VariableTestValues"] = testValues;
            return testValues;
        }
