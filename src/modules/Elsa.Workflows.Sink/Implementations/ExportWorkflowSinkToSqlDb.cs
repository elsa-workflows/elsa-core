...
public class ExportWorkflowSinkToSqlDb : ICommandHandler<ExportWorkflowSinkMessage>, IConsumer<ExportWorkflowSinkMessage>
{
    private readonly IEFCoreWorkflowSink _sinkProvider;
    private readonly IPrepareWorkflowSinkModel _prepareWorkflowSinkModel;

    public ExportWorkflowSinkToSqlDb(IEFCoreWorkflowSink sinkProvider, IPrepareWorkflowSinkModel prepareWorkflowSinkModel)
    {
