...
public class EFCoreWorkflowDefinitionStore : IWorkflowDefinitionStore
{
    ...
    {
        var data = new WorkflowDefinitionState(entity.Options, entity.Variables, entity.Inputs, entity.CustomProperties);
    ...
    private class WorkflowDefinitionState
    {
        ...
        public WorkflowDefinitionState(WorkflowOptions? options, ICollection<Variable> variables, ICollection<InputDefinition> inputs, IDictionary<string, object> customProperties)
        {
            Options = options;
            Variables = variables;
            Inputs = inputs;
