...
for module in "${mods[@]}"; do
    ...
    for provider in "${providers[@]}"; do
        ...
        ef-migration-runtime-schema --interface Elsa.Persistence.EFCore.IElsaDbContextSchema --efOptions "migrations add V3_7 -c ""$module""ElsaDbContext -p ""$providerPath""  -o ""$migrationsPath"" --startup-project ""$startupProject"""
    done
done
