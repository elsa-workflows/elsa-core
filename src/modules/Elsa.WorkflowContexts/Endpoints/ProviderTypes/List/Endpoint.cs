...
internal class List : ElsaEndpointWithoutRequest<Response>
{
    ...
    {
        Get("/workflow-contexts/provider-types");
        ConfigurePermissions("read:workflow-context-provider-types");
    }
...
[PublicAPI]
internal record Response(ICollection<WorkflowContextProviderDescriptor> ProviderTypes, int Count);
