...
public static class MongoDbFeatureHelper
{
    ...
    internal static void TryRegisterSerializerOrSkipWhenExist(Type type, IBsonSerializer serializer)
    {
       try
       {
    ...
    internal static IMongoDatabase CreateDatabase(IServiceProvider sp, string connectionString)
    {
