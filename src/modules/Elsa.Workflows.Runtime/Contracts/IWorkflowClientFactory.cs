...
public interface IWorkflowClientFactory
{
    ...
    IWorkflowClient CreateClient([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)]Type clientType, string workflowDefinitionVersionId, string? workflowInstanceId = null);
}