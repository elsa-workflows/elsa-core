...
public record UpdateBookmarksRequest(WorkflowExecutionContext WorkflowExecutionContext, string WorkflowInstanceId, Diff<Bookmark> Diff, string? CorrelationId = default);