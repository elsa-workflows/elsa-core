...
/// </summary>
public class SynchronousRunTaskDispatcher : IRunTaskDispatcher
{
    ...
    /// Constructor.
    /// </summary>
    public SynchronousRunTaskDispatcher(IEventPublisher eventPublisher) => _eventPublisher = eventPublisher;
