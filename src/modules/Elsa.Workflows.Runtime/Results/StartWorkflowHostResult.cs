...
public record ExecuteWorkflowResult(string WorkflowInstanceId, Diff<Bookmark> BookmarksDiff, WorkflowStatus Status, WorkflowSubStatus SubStatus, ICollection<ActivityIncident> Incidents);