...
/// </summary>
public class EngineExceptionHandlingMiddleware : IWorkflowExecutionMiddleware
{
    ...
    /// Constructor.
    /// </summary>
    public EngineExceptionHandlingMiddleware(WorkflowMiddlewareDelegate next, ISystemClock systemClock, ILogger<ExceptionHandlingMiddleware> logger)
    {
        _next = next;
