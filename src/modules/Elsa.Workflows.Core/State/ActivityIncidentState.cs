...
public record ActivityIncidentState(string ActivityId, string ActivityType, string Message, ExceptionState? Exception)
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ActivityIncidentState"/> class.
    /// </summary>
    [JsonConstructor]
    public ActivityIncidentState() : this(default!, default!, default!, default)
    {
    }
}