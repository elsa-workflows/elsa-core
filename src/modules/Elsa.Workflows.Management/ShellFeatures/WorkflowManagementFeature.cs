...
public class WorkflowManagementFeature : IShellFeature
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        services
            ...
            .AddScoped<WorkflowDefinitionActivityRegistryUpdater>()
            .AddScoped<IWorkflowDefinitionActivityRegistryUpdater>(sp => sp.GetRequiredService<WorkflowDefinitionActivityRegistryUpdater>())
            .AddScoped<IWorkflowDefinitionActivityRegistryReconciler>(sp => sp.GetRequiredService<WorkflowDefinitionActivityRegistryUpdater>())
