...
{
    private readonly IStore<LabelsDbContext, Label> _labelStore;
    private readonly IStore<LabelsDbContext, WorkflowDefinitionLabel> _workflowDefinitionLabelStore;

    public EFCoreLabelStore(IStore<LabelsDbContext, Label> labelStore, IStore<LabelsDbContext, WorkflowDefinitionLabel> workflowDefinitionLabelStore)
    {
