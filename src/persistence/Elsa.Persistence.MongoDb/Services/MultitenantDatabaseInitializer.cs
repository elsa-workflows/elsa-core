...
namespace Elsa.Persistence.MongoDb.Services
{
    public class MultitenantDatabaseInitializer : IStartupTask
    {
        ...
        public MultitenantDatabaseInitializer(ITenantStore tenantStore, IServiceScopeFactory scopeFactory)
        {
        ...
        private async Task CreateWorkflowInstancesIndexes(MultitenantElsaMongoDbContextProvider dbContextProvider, CancellationToken cancellationToken)
        {
        ...
        private async Task CreateWorkflowDefinitionsIndexes(MultitenantElsaMongoDbContextProvider dbContextProvider, CancellationToken cancellationToken)
        {
        ...
        private async Task CreateWorkflowExecutionLogIndexes(MultitenantElsaMongoDbContextProvider dbContextProvider, CancellationToken cancellationToken)
        {
        ...
        private async Task CreateBookmarkIndexes(MultitenantElsaMongoDbContextProvider dbContextProvider, CancellationToken cancellationToken)
        {
