...
namespace Elsa.Persistence.MongoDb
{
    public static class MongoDbSpecificationExtensions
    {
        ...
        public static IMongoQueryable<T> Apply<T>(this IMongoQueryable<T> queryable, IGroupingSpecification<T>? specification)
        {
        ...
        public static IMongoQueryable<T> Apply<T>(this IMongoQueryable<T> queryable, IPagingSpecification? specification) => specification == null ? queryable : queryable.Skip(specification.Skip).Take(specification.Take);
    }
}