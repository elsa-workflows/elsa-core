...
dotnet ef migrations add Update215 -- "Server=localhost;Port=3306;Database=elsa;User=root;Password=password;" "8.0.22"
...
dotnet ef migrations add Update215

REM SqlServer
cd ../Elsa.Persistence.EntityFramework.SqlServer
dotnet ef migrations add Update215 -- "{connection string}"
