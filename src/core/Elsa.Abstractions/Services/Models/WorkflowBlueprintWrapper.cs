...
namespace Elsa.Services.Models
{
    public class WorkflowBlueprintWrapper : IWorkflowBlueprintWrapper
    {
        ...
        private IEnumerable<IActivityBlueprintWrapper> GetActivityBlueprintWrappers()
        {
            ...
            {
                var activityExecutionContext = new ActivityExecutionContext(_workflowExecutionContext.ServiceScope, _workflowExecutionContext, activity, null, false, CancellationToken.None);
