...
namespace Elsa.Services
{
    public interface IWorkflowScheduler
    {
        ...
        /// </summary>
        Task TriggerWorkflowsAsync<TTrigger>(Func<TTrigger, bool> predicate, object? input = default, string? correlationId = default, CancellationToken cancellationToken = default) where TTrigger : ITrigger;
        ...
        /// </summary>
        Task ScheduleWorkflowDefinitionAsync(string definitionId, object? input = default, string? correlationId = default, CancellationToken cancellationToken = default);
