...
namespace Elsa.Services
{
    public abstract class Activity : IActivity
    {
        ...
        protected ScheduleActivitiesResult Schedule(params ActivityDefinition[] activities) => new ScheduleActivitiesResult(activities);
        protected ScheduleActivitiesResult Schedule(IEnumerable<ActivityDefinition> activities, object input) => new ScheduleActivitiesResult(activities, input);
        protected ScheduleActivitiesResult Schedule(ActivityDefinition activity, object input) => Schedule(new[] { activity }, input);
