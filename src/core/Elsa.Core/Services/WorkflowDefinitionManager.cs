...
namespace Elsa.Services
{
    public class WorkflowDefinitionManager : IWorkflowDefinitionManager
    {
        ...
        public ValueTask DeleteAsync(WorkflowDefinition workflowDefinition,
        ...
        public async ValueTask<IEnumerable<WorkflowDefinition>>
            ListAsync(CancellationToken cancellationToken = default) => await Query().ListAsync();

        public IQuery<WorkflowDefinition> Query() =>
            _session.Query<WorkflowDefinition>(CollectionNames.WorkflowDefinitions);

        public IQuery<WorkflowDefinition, TIndex> Query<TIndex>() where TIndex : class, IIndex =>
            _session.Query<WorkflowDefinition, TIndex>(CollectionNames.WorkflowDefinitions);
