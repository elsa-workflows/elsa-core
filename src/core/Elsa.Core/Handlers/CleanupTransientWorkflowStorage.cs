...
namespace Elsa.Handlers
{
    public class CleanupTransientWorkflowStorage : INotificationHandler<WorkflowExecutionBurstCompleted>
    {
        ...
        public async Task Handle(WorkflowExecutionBurstCompleted notification, CancellationToken cancellationToken) => await _transientWorkflowStorageProvider.DeleteAsync(notification.ActivityExecutionContext, cancellationToken);
    }
}