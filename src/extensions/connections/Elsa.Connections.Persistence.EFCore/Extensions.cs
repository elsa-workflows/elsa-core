...
public static class Extensions
{
    ...
    /// </summary>
    public static ConnectionPersistenceFeature UseEntityFrameworkCore(this ConnectionPersistenceFeature feature, Action<EFCoreConnectionPersistenceFeature>? configure = null)
    {
