...
public static class TransientPropertiesExecutionContextExtensions
{
    ...
    public static T? GetWorkflowContextParameter<T>(this WorkflowExecutionContext context, Type providerType, string? parameterName = null)
    {
        var scopedParameterName = providerType.GetScopedParameterName(parameterName);
    ...
    /// <returns>The parameter value.</returns>
    public static TParameter? GetWorkflowContextParameter<TProvider, TParameter>(this WorkflowExecutionContext context, string? parameterName = null) where TProvider : IWorkflowContextProvider
    {
