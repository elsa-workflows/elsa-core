...
public static class ModuleExtensions
{
    ...
    /// </summary>
    public static MassTransitDistributedCacheFeature UseMassTransit(this DistributedCacheFeature distributedCacheFeature, Action<MassTransitDistributedCacheFeature>? configure = null)
    {
    ...
    /// </summary>
    public static MemoryCacheFeature UseMassTransit(this MemoryCacheFeature memoryCacheFeature, Action<MassTransitDistributedCacheFeature>? configure = null)
    {
