...
{
    public abstract class ActivityHandler<T> : IActivityHandler<T> where T : IActivity
    {
        ...
        public virtual Task ReceiveInputAsync(WorkflowExecutionContext workflowContext, Variables input, CancellationToken cancellationToken)
        {
        ...
        protected virtual void ReceiveInput(WorkflowExecutionContext workflowContext, Variables input) {}
