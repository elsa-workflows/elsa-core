...
namespace Sample04
{
    public class CalculatorWorkflow : IWorkflow
    {
        ...
        {
            builder
                .StartWith<WriteLine>(x => x.Text = new LiteralExpression<string>("Welcome to Calculator Workflow!"))
                ...
                .Then<While>(
                    x => x.Condition = new JavaScriptExpression<bool>("!exit"),
                    whileActivity =>
                    {
                        whileActivity
                            ...
                            .Then<Switch>(
                                @switch =>
                                {
                                    @switch.Value = new JavaScriptExpression<string>("(operation)");
