...
{
    public async Task<TestResults> RunAsync(Scenario scenario, CancellationToken cancellationToken = default)
    {
        ...
        var assertionContext = new AssertionContext(runResult, cancellationToken);
