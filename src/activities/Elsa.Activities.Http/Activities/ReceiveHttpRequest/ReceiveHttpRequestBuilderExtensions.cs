...
namespace Elsa.Activities.Http
{
    ...
    {
        public static IActivityBuilder ReceiveHttpRequest(this IBuilder builder, Action<ISetupActivity<ReceiveHttpRequest>> setup) => builder.Then(setup);
        public static IActivityBuilder ReceiveHttpRequest(this IBuilder builder, Func<ActivityExecutionContext, ValueTask<PathString>> path) => builder.ReceiveHttpRequest(setup => setup.Set(x => x.Path, path));
        public static IActivityBuilder ReceiveHttpRequest(this IBuilder builder, Func<ActivityExecutionContext, PathString> path) => builder.ReceiveHttpRequest(setup => setup.Set(x => x.Path, path));
