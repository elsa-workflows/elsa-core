...
namespace Elsa.Activities.Http
{
    public static class WriteHttpResponseExtensions
    {
        ...
        public static ISetupActivity<WriteHttpResponse> WithContent(this ISetupActivity<WriteHttpResponse> activity, Func<ActivityExecutionContext, ValueTask<string?>> value) => activity.Set(x => x.Content, value);
        public static ISetupActivity<WriteHttpResponse> WithContent(this ISetupActivity<WriteHttpResponse> activity, Func<ValueTask<string?>> value) => activity.Set(x => x.Content, value);
        public static ISetupActivity<WriteHttpResponse> WithContent(this ISetupActivity<WriteHttpResponse> activity, Func<ActivityExecutionContext, string?> value) => activity.Set(x => x.Content, value);
        public static ISetupActivity<WriteHttpResponse> WithContent(this ISetupActivity<WriteHttpResponse> activity, Func<string?> value) => activity.Set(x => x.Content, value);
        public static ISetupActivity<WriteHttpResponse> WithContent(this ISetupActivity<WriteHttpResponse> activity, string? value) => activity.Set(x => x.Content, value);

        public static ISetupActivity<WriteHttpResponse> WithContentType(this ISetupActivity<WriteHttpResponse> activity, Func<ActivityExecutionContext, ValueTask<string?>> value) => activity.Set(x => x.ContentType, value);
        public static ISetupActivity<WriteHttpResponse> WithContentType(this ISetupActivity<WriteHttpResponse> activity, Func<ValueTask<string?>> value) => activity.Set(x => x.ContentType, value);
        public static ISetupActivity<WriteHttpResponse> WithContentType(this ISetupActivity<WriteHttpResponse> activity, Func<ActivityExecutionContext, string?> value) => activity.Set(x => x.ContentType, value);
        public static ISetupActivity<WriteHttpResponse> WithContentType(this ISetupActivity<WriteHttpResponse> activity, Func<string?> value) => activity.Set(x => x.ContentType, value);
        public static ISetupActivity<WriteHttpResponse> WithContentType(this ISetupActivity<WriteHttpResponse> activity, string? value) => activity.Set(x => x.ContentType, value);
