...
{
    public class EntityChangedTrigger : ITrigger
    {
    ...
    {
        public override async ValueTask<IEnumerable<ITrigger>> GetTriggersAsync(TriggerProviderContext<EntityChanged> context, CancellationToken cancellationToken) =>
            new[]
            {
