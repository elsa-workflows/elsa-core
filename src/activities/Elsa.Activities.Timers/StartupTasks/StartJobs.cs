...
namespace Elsa.Activities.Timers.StartupTasks
{
    ...
    public class StartJobs : IStartupTask
    {
        ...
        {
            var workflowInstanceCount = await _workflowInstanceStore.CountAsync(new WorkflowDefinitionIdSpecification(workflowDefinitionId).And(new WorkflowIsAlreadyExecutingSpecification()));
