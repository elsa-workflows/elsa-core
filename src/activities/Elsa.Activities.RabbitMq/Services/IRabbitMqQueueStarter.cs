...
namespace Elsa.Activities.RabbitMq.Services
{
    public interface IRabbitMqQueueStarter
    {
        ...
        IAsyncEnumerable<RabbitMqBusConfiguration> GetConfigurationsAsync<T>(Func<IWorkflowBlueprint, bool>? predicate, IServiceProvider serviceProvider, CancellationToken cancellationToken) where T : IRabbitMqActivity;
    }
}