...
namespace Elsa.Activities.OpcUa.Services
{
    public class BusClientFactory : IMessageReceiverClientFactory, IMessageSenderClientFactory
    {
        ...
        public async Task<IClient> GetReceiverAsync(OpcUaBusConfiguration configuration, CancellationToken cancellationToken)
        {
        ...
        public async Task<IClient> GetSenderAsync(OpcUaBusConfiguration configuration, CancellationToken cancellationToken)
        {
            await _semaphore.WaitAsync(cancellationToken);
