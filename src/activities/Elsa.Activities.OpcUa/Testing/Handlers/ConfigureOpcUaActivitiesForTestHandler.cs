...
{
    public class ConfigureOpcUaActivitiesForTestHandler : INotificationHandler<WorkflowExecuting>, INotificationHandler<WorkflowFaulted>, INotificationHandler<WorkflowCompleted>, INotificationHandler<WorkflowTestExecutionStopped>
    {
        private readonly IOpcUaTestQueueManager _OpcUaTestQueueManager;

        public ConfigureOpcUaActivitiesForTestHandler(IOpcUaTestQueueManager OpcUaTestQueueManager)
        {
            _OpcUaTestQueueManager = OpcUaTestQueueManager;
        }
        ...
        public async Task Handle(WorkflowExecuting notification, CancellationToken cancellationToken)
        {
            ...
            await _OpcUaTestQueueManager.CreateTestWorkersAsync(workflowId, workflowInstanceId, cancellationToken);
        }
        ...
        {
            _OpcUaTestQueueManager.DisposeTestWorkersAsync(notification.WorkflowInstanceId);
        ...
        private Task HandleTesttWorkflowExecutionFinished(WorkflowNotification notification, CancellationToken cancellationToken)
        {
            ...
            _OpcUaTestQueueManager.DisposeTestWorkersAsync(workflowInstanceId);
