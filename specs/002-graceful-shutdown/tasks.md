...
- [X] T063 [US3] Create `IInterruptedRecoveryScan` contract with `ScanAndRequeueAsync(CancellationToken) : ValueTask<int>` (returns count requeued) in `src/modules/Elsa.Workflows.Runtime/Contracts/IInterruptedRecoveryScan.cs`
